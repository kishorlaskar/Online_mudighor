    ...
    <div class="ads-grid">
        <div class="container">
            ...
            <div class="side-bar col-md-3">
                ...
                <!-- food preference -->
                <div class="left-side">
                    <h3 class="agileits-sear-head">All Catagories</h3>
                    <div class="list-group">
                        @foreach($catagories as $catagory)

                        <a href="{{route('catagorey-product',['id'=> $catagory->id ])}}" class=" list-group-item list-group-item-action">
                            {{$catagory->catagorey_name}}
                        </a>
                        @endforeach
                        ...
                        <div class="col-md-4 product-men">
                            ...
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset($product->product_image)}}" alt="" height="50" width="50">
