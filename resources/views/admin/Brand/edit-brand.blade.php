                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('update-brand')}}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="brand_details" class="form-control"value="{{$brand->brand_details}}" style="padding: 50px" >
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Publication Status</label>
                            <div class="col-md-9">
                                <input type="radio" name="publish_status" checked value="{{ $brand->publish_status}}">Published
                                <input type="radio" name="publish_status"  value="{{ $brand->publish_status}}">Unpublished
                            </div>
                        </div>
                        <div class="form-group">
